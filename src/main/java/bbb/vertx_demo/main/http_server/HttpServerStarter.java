...
import static bbb.vertx_demo.main.http_server.hidden.Countries.countries;
import static bbb.vertx_demo.main.http_server.hidden.FdaAdvisoryCommiteeCalendar.fdaAdvisoryCommitteeCalendar;
import static bbb.vertx_demo.main.http_server.hidden.IpoCalendar.ipoCalendar;
import static bbb.vertx_demo.main.http_server.hidden.News.news;
import static bbb.vertx_demo.main.http_server.hidden.crypto.CryptoExchanges.cryptoExchange;
import static bbb.vertx_demo.main.http_server.hidden.crypto.CryptoSymbols.cryptoSymbol;
import static bbb.vertx_demo.main.http_server.hidden.forex.ForexExchanges.forexExchange;
import static bbb.vertx_demo.main.http_server.hidden.forex.ForexSymbol.forexSymbol;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockEarnings.stockEarnings;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockFilings.stockFilings;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockFinancialsReported.stockFinancialsReported;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockInsiderSentiment.stockInsiderSentiment;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockInsiderTransactions.stockInsiderTransactions;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockMarketHoliday.stockMarketHoliday;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockProfile2.stockProfile2;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockRecommendation.stockRecommendation;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockSymbol.deploySymbolVerticle;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockSymbol.stockSymbol;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockUsaSpending.stockUsaSpending;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockUsptoPatent.stockUsptoPatent;
import static bbb.vertx_demo.main.http_server.hidden.stock.StockVisaApplications.stockVisaApplication;
