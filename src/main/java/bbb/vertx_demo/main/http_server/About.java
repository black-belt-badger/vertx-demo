...
public enum About {
    ...
    static Handler<RoutingContext> about
            (
        ...
        return context -> {
            ...
            redisApi
                    .get(REDIS_KEY)
                    .onFailure(throwable -> log.error("error getting about page from Redis", throwable))
                    .onSuccess(redisResponse -> {
                                if (nonNull(redisResponse)) {
                                    ...
                                    renderingContext.put("pageTitle", "About");
                                    engine
                                            .render(renderingContext, "templates/about.html")
